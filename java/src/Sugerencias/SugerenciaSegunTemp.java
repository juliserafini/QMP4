...
public class SugerenciaSegunTemp {
  ...
  public SugerenciaSegunTemp(List<Prenda> partesSuperiores, List<Prenda> partesInferiores, List<Prenda> calzados, List<Prenda> accesorios, ServicioMeteorologico climaReciente){
