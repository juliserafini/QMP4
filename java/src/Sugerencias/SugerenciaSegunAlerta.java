...
public class SugerenciaSegunAlerta {
  ...
  public SugerenciaSegunAlerta(List<Prenda> partesSuperiores, List<Prenda> partesInferiores, List<Prenda> calzados, List<Prenda> accesorios, ServicioMeteorologico climaReciente){
